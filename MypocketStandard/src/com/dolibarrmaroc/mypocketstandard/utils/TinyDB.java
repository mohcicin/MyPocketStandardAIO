...
public class TinyDB {
	...
	/********************
	********************/
	public void saveMapRemises (String key,Map<String, Remises> map) {
		SharedPreferences.Editor editor = preferences.edit();
	...
	public Map<String, Remises> loadMapRemises(String key) {
		Type type = new TypeToken<Map<String, Remises>>(){}.getType();
		String pf = preferences.getString(key, "");
		Map<String, Remises> myMap = new Gson().fromJson(pf,type);
	    
	    return myMap;
	}
	
	
	public void saveMapPromotion (String key,Map<String, Promotion> map) {
		SharedPreferences.Editor editor = preferences.edit();
	    editor.putString(key, new Gson().toJson(map));
	    editor.commit();
	    //myMap = map;
	...
	public Map<String, Promotion> loadMapPromotion(String key) {
		Type type = new TypeToken<Map<String, Promotion>>(){}.getType();
		String pf = preferences.getString(key, "");
		Map<String, Promotion> myMap = new Gson().fromJson(pf,type);
	    
	    return myMap;
	}
	
	
	public void saveMapTotaux (String key,Map<String, TotauxTicket> map) {
		SharedPreferences.Editor editor = preferences.edit();
	    editor.putString(key, new Gson().toJson(map));
	    editor.commit();
	    //myMap = map;
	...
	public Map<String, TotauxTicket> loadMapTotaux(String key) {
		Type type = new TypeToken<Map<String, TotauxTicket>>(){}.getType();
		String pf = preferences.getString(key, "");
		Map<String, TotauxTicket> myMap = new Gson().fromJson(pf,type);
