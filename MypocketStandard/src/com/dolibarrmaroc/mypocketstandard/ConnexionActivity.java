...
import com.dolibarrmaroc.mypocketstandard.logger.LogerrorsActivity;
...
import com.dolibarrmaroc.mypocketstandard.utils.UpdateApp;
				...
				if(file.exists()){
					...
					if(file.listFiles().length > 0){
						for (File fx: file.listFiles()) {
							File fl = new File(Environment.getExternalStorageDirectory()+com.dolibarrmaroc.mypocketstandard.utils.URL.path+"/"+com.dolibarrmaroc.mypocketstandard.utils.URL.path_log+"/"+fx.getName());
							if(compte != null){
